...
/**
 * minidao拦截器
 * @ClassName: MinidaoInterceptor 
 * @Description: TODO minidao拦截器实现【自动填充：创建人，创建时间，修改人，修改时间】
 * @author: wh
 */
@Service
public class MinidaoInterceptor implements EmptyInterceptor {
	...
	public boolean onInsert(Field[] fields, Object obj) {
		...
		Map<Object, Object> map = new HashMap<Object, Object>(20);
	...
	private static void setFieldValue(Map<Object, Object> map, Object bean) throws Exception {
		...
		for (Field field : fields) {
			...
			Object aobj=field.get(bean);
			Object nullObject=null;
			if(aobj instanceof String){
				if ("".equals((String)aobj)) {
					method.invoke(bean, nullObject);
				}
			}
