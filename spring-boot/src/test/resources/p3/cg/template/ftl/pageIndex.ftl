								...
								<tbody>
									...
									#foreach($!{info} in $!{pageInfos})
										<tr>			
											...
											<td class="last">
											<a class="btn btn-warning btn-xs" href="javascript:doUrl('$!{basePath}/${projectName}/${lowerName}.do?toEdit&id=$!{info.id}')" >编辑</a>
											<a class="btn btn-danger btn-xs" href="javascript:delData('$!{basePath}/${projectName}/${lowerName}.do?doDelete&id=$!{info.id}')">删除</a>
											<a class="btn btn-success btn-xs" href="javascript:doUrl('$!{basePath}/${projectName}/${lowerName}.do?toDetail&id=$!{info.id}')">详情</a>
											</td>
										</tr>
									 #end
								 #end
